...
const menusData = [
  ...
  { kodeModul: 'OPERASIONAL_ZIS', kodeMenu: 'program', namaMenu: 'Program & Pagu Anggaran', kodeTampil: 'PR', icon: 'FolderKanban', urutan: 4, actions: [...read('Lihat Program ZIS'), { aksi: 'update', nama: 'Ubah Program & Pagu' }, { aksi: 'delete', nama: 'Hapus Program ZIS' }] },
