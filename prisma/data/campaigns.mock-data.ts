/** Campaign seed data — mirrors webpublic/src/mocks/campaigns.ts */
export const campaignsMockData = [
  ...
  },
  {
    ...
    kabar: [{ tgl: '22 Juli 2026', judul: '2.106 ekor sudah terkumpul', isi: 'Tahap pertama distribusi disiapkan untuk 14 provinsi.' }],
    donaturList: [
  ...
  },
  {
    ...
    kabar: [{ tgl: '21 Juli 2026', judul: '12.480 pohon tertanam', isi: 'Tingkat hidup tanaman mencapai 91% pada evaluasi triwulan kedua.' }],
    donaturList: [],
    status: 'Berjalan',
    isFeatured: true,
  },
  {
    ...
    kabar: [{ tgl: '20 Juli 2026', judul: 'Target terlampaui', isi: 'Kelebihan dana dialihkan ke gelombang berikutnya atas persetujuan donatur.' }],
    donaturList: [],
    status: 'Tercapai',
    isFeatured: true,
  },
  {
    ...
    kabar: [{ tgl: '19 Juli 2026', judul: '415 pasien terlayani', isi: 'Sembilan unit konsentrator pertama sudah beredar di rumah pasien.' }],
    donaturList: [],
    status: 'Berjalan',
    isFeatured: true,
  },
  {
    ...
    kabar: [{ tgl: '18 Juli 2026', judul: 'Angkatan kelima dimulai', isi: '42 ibu kepala keluarga memulai pendampingan bulan ini.' }],
    donaturList: [],
    status: 'Berjalan',
    isFeatured: true,
  },
  {
    ...
    kabar: [{ tgl: '15 Juli 2026', judul: 'Distribusi gizi tahap 3 tersalurkan', isi: '310 balita di 4 desa terpencil Garut Selatan telah menerima paket nutrisi lengkap.' }],
    donaturList: [],
    status: 'Berjalan',
    isFeatured: true,
  },
  {
    ...
    kabar: [{ tgl: '12 Juli 2026', judul: '35 ton beras siap salur', isi: 'Pengemasan paket 5kg beras premium telah rampung di gudang logistik Karawang.' }],
    donaturList: [],
    status: 'Berjalan',
    isFeatured: true,
  },
